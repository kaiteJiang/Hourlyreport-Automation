...
`2026.7.28.115` 是当前标准安装器基线。新电脑只分发 `Hourlyreport_automation_setup_v2026.7.28.115.exe`，用户选择目录后一次安装完成。
...
7. 验证 `dist/` 只包含 `Hourlyreport_automation_v2026.7.28.115.zip` 和 `Hourlyreport_automation_setup_v2026.7.28.115.exe`。
8. GitHub Release tag 使用 `v2026.7.28.115`，在线更新资产名为 `Hourlyreport_automation_v2026.7.28.115.zip`；完整安装器名为 `Hourlyreport_automation_setup_v2026.7.28.115.exe`，两者用途不同。
