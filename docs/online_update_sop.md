...
`2026.7.29.116` 是当前标准安装器基线。新电脑只分发 `Hourlyreport_automation_setup_v2026.7.29.116.exe`，用户选择目录后一次安装完成。
...
```cmd
.venv\Scripts\python.exe tools\build_publish_release.py --version 2026.7.29.116
```

7. 验证 `dist/` 只包含 `Hourlyreport_automation_v2026.7.29.116.zip` 和 `Hourlyreport_automation_setup_v2026.7.29.116.exe`。
8. GitHub Release tag 使用 `v2026.7.29.116`，在线更新资产名为 `Hourlyreport_automation_v2026.7.29.116.zip`；完整安装器名为 `Hourlyreport_automation_setup_v2026.7.29.116.exe`，两者用途不同。
